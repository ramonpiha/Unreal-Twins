...
public class HonoExampleConstants {
     ...
     */
    public static final int HONO_KAFKA_CONSUMER_PORT = Integer.parseInt(System.getProperty("consumer.port", "9094"));

    public static final String TENANT_ID = "70d85efc-a332-4cf2-8dba-c5b25e815a57";
